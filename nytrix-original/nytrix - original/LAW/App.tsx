...
import { Scale, Send, Info, RefreshCcw, Heart, Shield, Globe, BookOpen, Menu, X, Home, Users, AlertCircle, Award, Zap, LogOut } from 'lucide-react';
...
type PageType = 'landing' | 'analyzer' | 'knowledge' | 'lawyers' | 'guide' | 'sdg' | 'disclaimer' | 'privacy' | 'terms';
...
const App: React.FC = () => {
  ...
  if (currentPage === 'landing') {
    return <PremiumLandingPage onNavigate={(page) => setCurrentPage(page as any)} />;
  }
