      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-purple-900/60 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden border border-emerald-400/30">
          ...
          <div className="p-8">
            ...
            {/* Lawyer Login Info */}
            {loginMode === 'lawyer' && (
              <div className="mt-6 p-4 bg-purple-900/50 border border-emerald-400/30 rounded-lg">
                <p className="text-sm text-emerald-200">
                  <span className="font-semibold">👨‍⚖️ Lawyer Portal:</span>
                </p>
                <p className="text-sm text-emerald-300 mt-1">
                  Use credentials provided by admin after your registration approval.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="text-center mt-6 text-white text-sm">
          ...
          <p className="text-emerald-300 mt-1 text-xs">By Team JKM | Legal Assistance Platform</p>
        </div>
