...
const courtsApiRoutes = require('./routes/courtsApi');
const { 
  validateInput, 
  rateLimiter, 
  requestLogger, 
...
app.use(cors({
  origin: function (origin, callback) {
    ...
    if (allowedOrigins.length === 0 || allowedOrigins.includes(origin) || allowedOrigins.includes('*') || origin.includes('localhost') || origin.includes('127.0.0.1')) {
      return callback(null, true);
    }
    return callback(null, true); // Allow deployed web client
  },
...
// ============================================================
// COURTS API
// Court management and location services
// ============================================================
app.use('/api/courts', courtsApiRoutes);
