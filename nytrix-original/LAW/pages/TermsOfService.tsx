...
const TermsOfService: React.FC<TermsOfServiceProps> = ({ onBack }) => {
  const sections = [
    ...
    },
    {
      ...
      content: [
        "All content, features, and functionality on NYTRIX AI are owned by MALLESH SP and protected by intellectual property laws.",
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-slate-800/50 text-center">
          <p className="text-slate-500 text-sm">
            © 2026 NYTRIX AI. Created & Owned by MALLESH SP
          </p>
        </div>
      </div>
    </div>
